<?php
  ...
  function listarProduto($filtroNome) {
      ...
      foreach($produtos as $produto) {
          ...
          echo "<td><a href='http://localhost:81/padaria/telas/funcionario/cadastro_produtos.php?id=".$produto->id."'>Alterar</a> | <a href='http://localhost:81/padaria/telas/funcionario/cadastro_produtos.php?id=". $produto->id. "'>Remover</a></td>";
          echo "</tr>";
      }
      echo "</tbody></table>";
